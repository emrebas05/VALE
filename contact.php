        ...
        <div class="row">
            <div class="col-lg-10 m-auto">
                <div class="contact-form">
                    <form action="surucu.php" method="post">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="name-input">
                                    <input type="text" placeholder="Adınız Soyadınız" name="ad">
                                </div>
                            </div>

                            <div class="col-lg-6 col-md-6">
                                <div class="email-input">
                                    <input type="email" placeholder="Email Adresiniz" name="mail">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="website-input">
                                    <input type="phone" placeholder="Telefon Numaranız" name="telefon">
                                </div>
                            </div>
                        ...
                        <div class="message-input">
                            <textarea name="mesaj" cols="30" rows="10" placeholder="Mesajınız"></textarea>
                        </div>
